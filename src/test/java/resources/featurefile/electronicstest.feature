Feature: Top Menu Test
  ...
  Scenario: I should verify product is added successfully and order placed successfully
    ...
    And I register first name "Priya"
    And I register last name "Patel"
    And I register email "priyapatel"
    And I enter registration password "password1"
    And I enter registration confirmation password "password1"
